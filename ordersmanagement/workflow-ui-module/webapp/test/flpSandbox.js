		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordersmgtnspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordersmgtnspworkflowuimodule-display": {
								"semanticObject": "ordersmgtnspworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordersmgtnsp.workflowuimodule",
									"url": sap.ui.require.toUrl("ordersmgtnsp/workflowuimodule")
								}
							}
						}
					}
